...
class TestMasteryProximityDampening(unittest.TestCase):
    ...
    def test_cold_start_p_l_zero_is_undampened(self):
        ...
        # effective_cap at difficulty=0.5 (neutral) is MAX_MASTERY_DELTA
        # exactly, and proximity_scale=1.0 at p_l=0, so the full cap applies.
        self.assertAlmostEqual(new_p_l, MAX_MASTERY_DELTA, places=2)
