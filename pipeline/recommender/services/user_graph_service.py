...
class UserGraphService:
    ...
    def _fetch_user(self, user_id: str) -> Optional[UserNode]:
        ...
        # against a live instance of this same backend project: "user" is
        ...
        # seeding_controller.py::user_exists() already independently uses
        # the correct `"user"`/`id` form -- this query was the one file
        # still on the stale assumption.
        try:
    ...
    def _load_topic_mastery(self, graph: UserGraph, user_id: str) -> None:
        ...
        for row in rows:
            ...
            # schema (confirmed against a live instance of this same
            # backend project) -- the /100.0 here previously assumed a
            # 0-100 scale that doesn't exist, silently shrinking every
            # loaded mastery value to ~1/100th of its real value.
